...
public class filter extends Base {
    ...
    private productpage productpag;
    ...
    public void i_dragdown_the_page_visbile_filter() {
        ...
        try {
            ...
            productpag = new productpage(driver);
            productpag.dragDown();
   ...
   /* @Then("I take screenshot")
    public void i_take_screenshot() {
        ...
        try {
            extentTest.info("Taking a screenshot of the current state");
            screenshot = new Scrennshot(driver);
            String screenshotPath = screenshot.getScreenshot("products", driver);
            extentTest.pass("Screenshot taken", MediaEntityBuilder.createScreenCaptureFromPath(screenshotPath).build());
        } catch (Exception e) {
            extentTest.log(Status.FAIL, "Failed to take screenshot: " + e.getMessage());
        }
    }*/
}
